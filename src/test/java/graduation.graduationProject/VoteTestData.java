...
public class VoteTestData {
    ...
    public static final Vote VOTE_2 = new Vote(START_SEQ + 10, LocalDate.of(2020, 4, 6));
    public static final Vote VOTE_3 = new Vote(START_SEQ + 11,  LocalDate.of(2020, 4, 5));
