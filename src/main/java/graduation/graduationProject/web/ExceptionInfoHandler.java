...
import graduation.graduationProject.util.ValidationUtil;
import graduation.graduationProject.util.exception.ApplicationException;
import graduation.graduationProject.util.exception.ErrorInfo;
import graduation.graduationProject.util.exception.ErrorType;
import graduation.graduationProject.util.exception.IllegalRequestDataException;
...
import static graduation.graduationProject.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_NAME = "duplicate name";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "restaurants_idx", EXCEPTION_DUPLICATE_NAME);
